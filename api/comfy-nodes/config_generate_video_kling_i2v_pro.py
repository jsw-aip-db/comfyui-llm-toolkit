...
"""Configure Video Generation for Kling V2.1 I2V Pro.

Handles image-to-video parameters specific to the
`kwaivgi/kling-v2.1-i2v-pro` endpoint.
"""
...
class ConfigGenerateVideoKlingI2VPro:
    MODEL_ID = "kwaivgi/kling-v2.1-i2v-pro"
    ...
    def configure(
        ...
        logger.info("ConfigGenerateVideoKlingI2VPro executing…")
        ...
        logger.info("ConfigGenerateVideoKlingI2VPro: saved config %s", gen_cfg)
        return (out_ctx,)


NODE_CLASS_MAPPINGS = {
    "ConfigGenerateVideoKlingI2VPro": ConfigGenerateVideoKlingI2VPro
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "ConfigGenerateVideoKlingI2VPro": "Configure Kling 2.1 I2V Pro (LLMToolkit)"
} 