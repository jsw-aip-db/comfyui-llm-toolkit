...
"""Configure Video Generation for Kling V2.1 I2V Standard.

Handles image-to-video parameters specific to the
`kwaivgi/kling-v2.1-i2v-standard` endpoint.
"""
...
class ConfigGenerateVideoKlingI2VStandard:
    MODEL_ID = "kwaivgi/kling-v2.1-i2v-standard"
    ...
    def configure(
        ...
        logger.info("ConfigGenerateVideoKlingI2VStandard executing…")
        ...
        logger.info("ConfigGenerateVideoKlingI2VStandard: saved config %s", gen_cfg)
        return (out_ctx,)
