...
def load_tasks() -> Dict[str, Dict]:
    ...
    tasks_path = project_root / "presets" / "banana-tasks.json"
...
class BananaTaskGenerator:
    ...
    def INPUT_TYPES(cls):
        try:
            ...
            print(f"Error loading banana tasks for node: {e}")
            cls._task_names = ["Error: banana-tasks.json not found"]
    ...
    def generate_prompt(self, task: str, context: Optional[Dict[str, Any]] = None) -> Tuple[Dict[str, Any], str]:
        ...
        print(f"BananaTaskGenerator: Generated prompt for task '{task}'.")
